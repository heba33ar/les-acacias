...
const BOOKING_CONFIG = {
  ...
  // Caution / dépôt de garantie (montant indicatif, simplement affiché)
  securityDeposit: 0,
...
const translations = {
  fr: {
    ...
    'det.f1': 'Cuisine entièrement équipée',
    'det.f2': 'Climatisation',
    'det.f3': 'Wi-Fi haut débit gratuit',
    'det.f4': 'Salle de bains privative',
    'det.f5': 'Terrasse privative',
    'det.f6': 'Télévision écran plat',
    'det.f7': 'Linge de maison et serviettes fournis',
    'det.f8': 'Accès à la piscine et au jardin',
    'det.f9': 'Parking privé clos',
    ...
    'dom.f1': "Piscine à débordement à l'eau salée",
    'dom.f2': 'Jardin paysager et terrasses',
  ...
  en: {
    ...
    'det.f1': 'Fully equipped kitchen',
    'det.f2': 'Air conditioning',
    'det.f3': 'Free high-speed Wi-Fi',
    'det.f4': 'Private bathroom',
    'det.f5': 'Private terrace',
    'det.f6': 'Flat-screen TV',
    'det.f7': 'Linens and towels provided',
    'det.f8': 'Access to pool and garden',
    'det.f9': 'Private enclosed parking',
    ...
    'dom.f1': 'Infinity saltwater pool',
    'dom.f2': 'Landscaped garden and terraces',
...
if (bookingForm) {
  ...
  const BOOK_T = {
    fr: {
      ...
      total: 'Total estimé', deposit: (d) => `Caution de ${d} € (restituée après le séjour).`,
    ...
    en: {
      ...
      total: 'Estimated total', deposit: (d) => `Security deposit of €${d} (refunded after your stay).`,
